...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      adventurerCase(currentPlayer, state, z, cardDrawn, drawntreasure, temphand);
			
    case council_room:
      councilRoomCase(currentPlayer, state, handPos);
			
    case feast:
      feastCase(currentPlayer, temphand, state, choice1);
			
    case gardens:
      return -1;
			
    case mine:
      mineCase(currentPlayer, state, choice1, choice2, handPos);
    ...
    case smithy:
      smithyCase(currentPlayer, state, handPos);
...
int councilRoomCase(int currentPlayer, struct gameState *state, int handPos)
{
  //+4 Cards
  for (int i = 0; i < 4; i++)
	{
...
int feastCase(int currentPlayer, int temphand[MAX_HAND], struct gameState *state, int choice1)
{
...
int mineCase(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos)
{
...
int randomTest()
{
    while(1)
    {
        ...
        smithyCase(currentPlayer, gS, handPos);
        printf(gS->deckCount);
